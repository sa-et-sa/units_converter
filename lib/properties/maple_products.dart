...
enum MAPLE_PRODUCTS {
  ...
  lbsSnowTaffy,
  kilogramSnowTaffy,
  lbsPotTaffySoftSugarSoftCandy,
  kilogramPotTaffySoftSugarSoftCandy,
  lbsHardSugar,
  kilogramHardSugar,
  lbsGranulatedSugar,
...
class MapleProducts extends DoubleProperty<MAPLE_PRODUCTS> {
  ...
  MapleProducts({super.removeTrailingZeros, super.useScientificNotation, name})
      : super(
          ...
          mapSymbols: {
            ...
            MAPLE_PRODUCTS.lbsPotTaffySoftSugarSoftCandy: 'lbs',
            MAPLE_PRODUCTS.kilogramPotTaffySoftSugarSoftCandy: 'kg',
          ...
          conversionTree: ConversionNode(
              ...
              children: [
                ...
                ConversionNode(
                    coefficientProduct: 1 / 13.2476,
                    name: MAPLE_PRODUCTS.lbsSyrup),
                ConversionNode(
                    coefficientProduct: 1 / 6.009,
                    name: MAPLE_PRODUCTS.kilogramSyrup),
                ConversionNode(
                    coefficientProduct: 1 / 10.5,
                    name: MAPLE_PRODUCTS.lbsButter), //	Livres de beurre2
                ConversionNode(
                    coefficientProduct: 1 / 4.8,
                    name: MAPLE_PRODUCTS.kilogramButter), //	Kg de beurre2
                ConversionNode(
                    coefficientProduct: 1 / 10.4,
                    name: MAPLE_PRODUCTS
                        .lbsSnowTaffy), //	Livres de tire sur neige3
                ConversionNode(
                    coefficientProduct: 1 / 4.7,
                    name: MAPLE_PRODUCTS
                        .kilogramSnowTaffy), // 	Kg de tire sur neige3
                ConversionNode(
                    coefficientProduct: 1 / 10.2,
                    name: MAPLE_PRODUCTS
                        .lbsPotTaffySoftSugarSoftCandy), //	Livres de tire en pot.sucre mou. bonbon mou4
                ConversionNode(
                    coefficientProduct: 1 / 4.6,
                    name: MAPLE_PRODUCTS
                        .kilogramPotTaffySoftSugarSoftCandy), // 	Kg de tire en pot. sucre mou. bonbon mou4
                ConversionNode(
                    coefficientProduct: 1 / 9.2,
                    name: MAPLE_PRODUCTS.lbsHardSugar), //	Livres de sucre dur5
                ConversionNode(
                    coefficientProduct: 1 / 4.2,
                    name: MAPLE_PRODUCTS.kilogramHardSugar), //	Kg de sucre dur5
                ConversionNode(
                    coefficientProduct: 1 / 8.9,
                    name: MAPLE_PRODUCTS
                        .lbsGranulatedSugar), //	Livres de sucre granulé6
                ConversionNode(
                    coefficientProduct: 1 / 4.0,
                    name: MAPLE_PRODUCTS
                        .kilogramGranulatedSugar), //	Kg de sucre granulé6
                ConversionNode(
                    coefficientProduct: 1 / 180.0,
                    name: MAPLE_PRODUCTS
                        .taffyAndOrButterCones), //Cornets de tire. beurre. ou de beurre et tire
              ]),
        );
  ...
  Unit get lbsPotTaffySoftSugarSoftCandy =>
      getUnit(MAPLE_PRODUCTS.lbsPotTaffySoftSugarSoftCandy);
  Unit get kilogramPotTaffySoftSugarSoftCandy =>
      getUnit(MAPLE_PRODUCTS.kilogramPotTaffySoftSugarSoftCandy);
  ...
  Unit get kilogramGranulatedSugar =>
      getUnit(MAPLE_PRODUCTS.kilogramGranulatedSugar);
  Unit get taffyAndOrButterCones =>
      getUnit(MAPLE_PRODUCTS.taffyAndOrButterCones);
}
